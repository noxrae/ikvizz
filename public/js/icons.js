...
export const ICONS = {
  ...
  // ---- worlds & navigation ----------------------------------------------------
  sun: `<circle cx="12" cy="12" r="4" class="a"/><path d="M12 2.5V5M12 19v2.5M2.5 12H5M19 12h2.5M4.9 4.9l1.8 1.8M17.3 17.3l1.8 1.8M19.1 4.9l-1.8 1.8M6.7 17.3l-1.8 1.8"/>`,
  orbit: `<circle cx="12" cy="12" r="3.1" class="a"/><ellipse cx="12" cy="12" rx="9.2" ry="4.4" transform="rotate(-22 12 12)"/><circle cx="18.6" cy="7.6" r="1.3" class="a"/>`,
  rocket: `<path d="M12 2.8c3.2 1.7 4.8 4.8 4.8 8.3l-2.9 2.9h-3.8L7.2 11c0-3.5 1.6-6.5 4.8-8.2Z"/><circle cx="12" cy="8.7" r="1.6" class="a"/><path d="M8.2 12.6 5.7 15c-.6 1.7-.7 3.3-.7 3.3s1.6-.1 3.3-.7l2.4-2.4"/><path d="M15.8 12.6l2.5 2.4c.6 1.7.7 3.3.7 3.3s-1.6-.1-3.3-.7l-2.4-2.4"/><path d="M12 17v4"/>`,
  db: `<ellipse cx="12" cy="5.6" rx="7.4" ry="2.9"/><path d="M4.6 5.6v12.8c0 1.6 3.3 2.9 7.4 2.9s7.4-1.3 7.4-2.9V5.6"/><path d="M4.6 12c0 1.6 3.3 2.9 7.4 2.9s7.4-1.3 7.4-2.9"/><path d="M12 8.7l.7 1.5 1.6.2-1.2 1.1.3 1.6-1.4-.8-1.4.8.3-1.6-1.2-1.1 1.6-.2.8-1.5Z" class="a"/>`,
  planet: `<circle cx="12" cy="12" r="5"/><ellipse cx="12" cy="12" rx="10" ry="3.2" transform="rotate(-18 12 12)"/>`,
  home: `<path d="m4 11 8-7 8 7"/><path d="M6 9.5V20h12V9.5"/><path class="a" d="M10 20v-5.4h4V20"/>`,
  ...
  lock: `<rect x="5.2" y="10.8" width="13.6" height="9.4" rx="2.4"/><path d="M8.6 10.8V7.9a3.4 3.4 0 0 1 6.8 0v2.9"/><circle cx="12" cy="15.4" r="1.4" class="a"/>`,
  ...
  star: `<path class="a" d="m12 3.6 2.5 5.2 5.8.8-4.2 4 1 5.7L12 16.6l-5.1 2.7 1-5.7-4.2-4 5.8-.8L12 3.6Z"/>`,
  ...
  mic: `<rect x="9" y="3.5" width="6" height="11" rx="3" class="a"/><path d="M5.5 11.5a6.5 6.5 0 0 0 13 0M12 18v3M9 21h6"/>`,
  ...
  video: `<rect x="3" y="6.5" width="12.5" height="11" rx="2.4"/><path d="m15.5 10.6 5-3.1v9l-5-3.1z" class="a"/>`,
  ...
  camera: `<path d="M4 8.6c0-1.1.9-2 2-2h1.5l1.3-2.1h6.4l1.3 2.1H18a2 2 0 0 1 2 2v8.9a2 2 0 0 1-2 2H6a2 2 0 0 1-2-2V8.6Z"/><circle cx="12" cy="12.8" r="3.3" class="a"/>`,
  ...
  zap: `<path class="hf" d="M13 2.5 4.5 13.5h6L9 21.5 19.5 10h-6l-.5-7.5Z"/>`,
  mappin: `<path d="M12 21s7-6.4 7-12A7 7 0 0 0 5 9c0 5.6 7 12 7 12Z"/><circle cx="12" cy="9.2" r="2.6" class="a"/>`,
  ...
  bell: `<path d="M12 3.5a5.8 5.8 0 0 1 5.8 5.8c0 4 1 5.3 2 6.4H4.2c1-1.1 2-2.4 2-6.4A5.8 5.8 0 0 1 12 3.5Z"/><path d="M9.8 19.2a2.3 2.3 0 0 0 4.4 0"/><circle cx="17.4" cy="6" r="2.4" class="a"/>`,
  pin: `<path class="a" d="M9 3.8h6l-.8 6.4 2.6 2.6c.4.4.1 1.2-.5 1.2H7.7c-.6 0-.9-.8-.5-1.2l2.6-2.6L9 3.8Z"/><path d="M12 14v6.5"/>`,
  ...
  crown: `<path class="hf" d="M4.6 17 3.4 7.6l4.7 3.3L12 5l3.9 5.9 4.7-3.3L19.4 17H4.6Z"/><path class="h" d="M5.4 20h13.2"/>`,
  ...
  message: `<path d="M20.5 11.6a8.5 8.5 0 0 1-12.3 7.6L3.5 20.5l1.2-4.5a8.5 8.5 0 1 1 15.8-4.4Z"/><circle cx="9" cy="11.8" r="1.1" class="a"/><circle cx="12.4" cy="11.8" r="1.1" class="a"/><circle cx="15.8" cy="11.8" r="1.1" class="a"/>`,
  flame: `<path class="hf" d="M12 21c-3.9 0-6.5-2.4-6.5-5.9C5.5 11.2 9 9.6 9.5 6c2.6 1.5 3.5 3.7 3.1 5.8 1.2-.4 2-1.3 2.3-2.7 2 1.7 3.6 3.9 3.6 6 0 3.5-2.6 5.9-6.5 5.9Z"/>`,
  trend: `<path d="m3.5 17 5.4-5.4 3.5 3.5 8-8.1"/><path d="M15.2 7h5.3v5.3"/>`,
  dna: `<path d="M8 3c0 4.6 8 4.4 8 9s-8 4.4-8 9"/><path d="M16 3c0 4.6-8 4.4-8 9s8 4.4 8 9"/><path class="h" d="M8.7 6.3h6.6M8.7 17.7h6.6M9.8 12h4.4"/>`,
  ...
  target: `<circle cx="12" cy="12" r="8.5"/><circle cx="12" cy="12" r="4.7"/><circle cx="12" cy="12" r="1.6" class="a"/>`,
  ...
  smile: `<circle cx="12" cy="12" r="8.5"/><path d="M8.6 14c.9 1.3 2 2 3.4 2s2.5-.7 3.4-2"/><circle cx="9.2" cy="9.8" r="1" class="a"/><circle cx="14.8" cy="9.8" r="1" class="a"/>`,
